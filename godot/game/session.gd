...
func _draw() -> void:
	...
	# Background/grid/decoration span the full level width so the Zone 3
	# extension (walker-jumpman-yuan) is not silently cut off past x=960.
	draw_rect(Rect2(-400, -200, width + 840, 900), Color("f6f3ec"))
